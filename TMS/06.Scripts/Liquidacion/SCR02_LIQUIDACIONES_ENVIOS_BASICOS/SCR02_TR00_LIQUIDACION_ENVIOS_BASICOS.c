SCR02_TR00_LIQUIDACION_ENVIOS_BASICOS()
{
	...
	lr_start_transaction("SCR02_TR02_LIQUIDACION_ENVIOS_BASICOS_DELIVERY");
	...
	lr_end_transaction("SCR02_TR02_LIQUIDACION_ENVIOS_BASICOS_DELIVERY",LR_AUTO);
	
	lr_think_time(3);
	
	//eN CAD AGRUPACION, CADA 100. cUANDO CMABIA LA RUTA Y AGURPACION
	
	lr_start_transaction("SCR02_TR03_LIQUIDACION_ENVIOS_BASICOS_UNITRETURNS");
	...
	lr_end_transaction("SCR02_TR03_LIQUIDACION_ENVIOS_BASICOS_UNITRETURNS",LR_AUTO);
