SCR02_TR00_LIQUIDACION_CITYPAQ()
{
	...
	lr_start_transaction("SCR02_TR02_LIQUIDACION_CITYPAQ_DELIVERY");
	...
	lr_end_transaction("SCR02_TR02_LIQUIDACION_CITYPAQ_DELIVERY",LR_AUTO);
	
	lr_think_time(3);
	
	lr_start_transaction("SCR02_TR03_LIQUIDACION_CITYPAQ_UNITRETURNS");
	...
	lr_end_transaction("SCR02_TR03_LIQUIDACION_CITYPAQ_UNITRETURNS",LR_AUTO);
