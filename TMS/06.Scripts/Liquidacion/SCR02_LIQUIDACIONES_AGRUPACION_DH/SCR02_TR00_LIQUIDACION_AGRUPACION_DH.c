SCR02_TR00_LIQUIDACION_AGRUPACION_DH()
{
	...
	lr_start_transaction("SCR02_TR02_LIQUIDACION_AGRUPACION_DH_DELIVERY");
	...
	web_rest("POST: https://api1-intapp.correospre.es/logistics/logist...",
		...
		"\"longitude\": 23.32\r\n"
		"},\r\n"
		"\"groupId\": {groupid_agrupacion_dh},\r\n"
		"\"itemCode\": \"{itemid_agrupacion_dh}\",\r\n"
		//"\"itemsQuantity\": {num_bulto_agrupacion_dh},\r\n"
		"\"itemsQuantity\": 1,\r\n"
	...
	lr_end_transaction("SCR02_TR02_LIQUIDACION_AGRUPACION_DH_DELIVERY",LR_AUTO);
	
	lr_think_time(3);
	
	//  "message": "No fue posible recuperar agrupaciones para la ruta PC00, fecha Mon Apr 10 
	
	lr_start_transaction("SCR02_TR03_LIQUIDACION_AGRUPACION_DH_UNITRETURNS");
	...
	lr_end_transaction("SCR02_TR03_LIQUIDACION_AGRUPACION_DH_UNITRETURNS",LR_AUTO);
