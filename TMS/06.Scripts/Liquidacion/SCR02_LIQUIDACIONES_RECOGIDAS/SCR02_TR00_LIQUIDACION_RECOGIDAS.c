SCR02_TR00_LIQUIDACION_RECOGIDAS()
{
	...
	lr_start_transaction("SCR02_TR02_LIQUIDACION_RECOGIDAS_DELIVERY");
	...
	web_rest("POST: https://api1-intapp.correospre.es/logistics/logist...",
		...
		"\"longitude\": 23.32\r\n"
		"},\r\n"
		"\"groupId\": {groupid_recogida},\r\n"
		"\"itemCode\": \"{itemid_recogida}\",\r\n"
		//"\"itemsQuantity\": {num_bulto_recogida},\r\n"
		"\"itemsQuantity\": 1,\r\n"
		"\"route\": \"{ruta_recogida}\",\r\n"
	...
	lr_end_transaction("SCR02_TR02_LIQUIDACION_RECOGIDAS_DELIVERY",LR_AUTO);
	
	lr_think_time(3);
	
	lr_start_transaction("SCR02_TR03_LIQUIDACION_RECOGIDAS_UNITRETURNS");
	...
	lr_end_transaction("SCR02_TR03_LIQUIDACION_RECOGIDAS_UNITRETURNS",LR_AUTO);
